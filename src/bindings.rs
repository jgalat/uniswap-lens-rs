...
create_sol_binding!(ephemeralgetpopulatedticksinrange, EphemeralGetPopulatedTicksInRange);
create_sol_binding!(ephemeralgetpopulatedticksinrangev4, EphemeralGetPopulatedTicksInRangeV4);
create_sol_binding!(ephemeralgetposition, EphemeralGetPosition);
create_sol_binding!(ephemeralgetpositionv4, EphemeralGetPositionV4);
create_sol_binding!(ephemeralgetpositions, EphemeralGetPositions);
create_sol_binding!(ephemeralgetpositionsv4, EphemeralGetPositionsV4);
